...
class BiaffineDependencyModel(Model):
    ...
    def __init__(self,
        ...
        # yeshu's code begin
        # self.random_biaffine = Biaffine(n_in=n_arc_mlp, n_out=10, scale=scale, bias_x=True, bias_y=True)
        # stdv = 1. / np.sqrt(self.random_biaffine.weight.size(1))
        # self.random_biaffine.weight.data.uniform_(-stdv, stdv)
        # nn.init.xavier_uniform_(self.random_biaffine.weight)
        # nn.init.uniform_(self.random_biaffine.weight, -1, 1)
        # yeshu's code end
    ...
    def forward(self, words, feats=None):
        ...
        # yeshu's code begin
        # s_random_feature = self.random_biaffine(arc_d, arc_h).permute(0, 2, 3, 1)
        # s_random_feature = s_arc.unsqueeze(1).permute(0, 2, 3, 1)
        s_random_feature = torch.cat((arc_h.unsqueeze(1), arc_d.unsqueeze(1)), dim = 1)

        return s_arc, s_rel, s_random_feature
        # yeshu's code end
...
class CRF2oDependencyModel(BiaffineDependencyModel):
    ...
    def forward(self, words, feats=None):
        ...
        return s_arc, s_sib, s_rel, s_random_feature
        # yeshu's code end
